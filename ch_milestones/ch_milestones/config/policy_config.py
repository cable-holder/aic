...
SFP_ORACLE_DEFAULTS = {
    ...
    "oracle_coarse_align_rotation_step_radians": 0.005,
    ...
    "oracle_fine_align_hold_steps": 60,
    "oracle_alignment_fine_align_z_offset": 0.175,
    "oracle_alignment_fine_align_steps": 87,
    "oracle_alignment_insert_step_meters": 0.001,
    ...
    "oracle_divergence_tolerance_meters": 0.10,
    "oracle_divergence_consecutive_steps": 5,
    "oracle_stop_on_insertion_event": True,
    "oracle_insertion_event_topic": "/scoring/insertion_event",
    "oracle_insert_step_meters": 0.001,
